...
{
    public partial class VictoryControl : UserControl
    {
        private string _tempJsonFile;

        public VictoryControl()
        {
            InitializeComponent();
            LoadJsonResource("victory.json");
        }
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                var lottieAnimationView = (LottieAnimationView)this.FindName("LottieVictoryAnimationView");
